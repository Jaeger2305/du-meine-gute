...
public class WebSocket extends org.java_websocket.client.WebSocketClient
  ...
  public WebSocket(
      java.net.URI param_0, java.util.Map<java.lang.String, java.lang.String> param_1) {
    super(param_0, param_1);
    com.tns.Runtime.initInstance(this);
  }

  public WebSocket(
      java.net.URI param_0,
      org.java_websocket.drafts.Draft param_1,
      java.util.Map<java.lang.String, java.lang.String> param_2) {
  ...
  public void onWebsocketHandshakeReceivedAsClient(
      org.java_websocket.WebSocket param_0,
      org.java_websocket.handshake.ClientHandshake param_1,
      org.java_websocket.handshake.ServerHandshake param_2) {
    java.lang.Object[] args = new java.lang.Object[3];
    args[0] = param_0;
    args[1] = param_1;
    args[2] = param_2;
